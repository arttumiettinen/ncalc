...
// $ANTLR null C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g 2020-06-25 15:12:19
...
public partial class NCalcParser : Antlr.Runtime.Parser
{
	...
	public override string GrammarFileName { get { return "C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g"; } }
	...
	// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:78:1: ncalcExpression returns [LogicalExpression value] : logicalExpression EOF !;
	...
	public NCalcParser.ncalcExpression_return ncalcExpression()
	{
		...
		try
		{
			// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:79:2: ( logicalExpression EOF !)
			DebugEnterAlt(1);
			// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:79:4: logicalExpression EOF !
			{
	...
	// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:82:1: logicalExpression returns [LogicalExpression value] : left= conditionalExpression ( '?' middle= conditionalExpression ':' right= conditionalExpression )? ;
	...
	private NCalcParser.logicalExpression_return logicalExpression()
	{
		...
		try
		{
			// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:83:2: (left= conditionalExpression ( '?' middle= conditionalExpression ':' right= conditionalExpression )? )
			DebugEnterAlt(1);
			// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:83:4: left= conditionalExpression ( '?' middle= conditionalExpression ':' right= conditionalExpression )?
			{
			root_0 = (CommonTree)adaptor.Nil();
			...
			DebugLocation(83, 57);
			// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:83:57: ( '?' middle= conditionalExpression ':' right= conditionalExpression )?
			int alt1=2;
			...
			case 1:
				DebugEnterAlt(1);
				// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:83:59: '?' middle= conditionalExpression ':' right= conditionalExpression
				{
				DebugLocation(83, 59);
	...
	// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:86:1: conditionalExpression returns [LogicalExpression value] : left= booleanAndExpression ( ( '||' | 'or' ) right= conditionalExpression )* ;
	...
	private NCalcParser.conditionalExpression_return conditionalExpression()
	{
		...
		try
		{
			// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:90:2: (left= booleanAndExpression ( ( '||' | 'or' ) right= conditionalExpression )* )
			DebugEnterAlt(1);
			// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:90:4: left= booleanAndExpression ( ( '||' | 'or' ) right= conditionalExpression )*
			{
			root_0 = (CommonTree)adaptor.Nil();
			...
			DebugLocation(90, 56);
			// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:90:56: ( ( '||' | 'or' ) right= conditionalExpression )*
			...
			while (true)
			{
				...
				case 1:
					DebugEnterAlt(1);
					// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:91:4: ( '||' | 'or' ) right= conditionalExpression
					{
					DebugLocation(91, 4);
	...
	// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:96:1: booleanAndExpression returns [LogicalExpression value] : left= bitwiseOrExpression ( ( '&&' | 'and' ) right= bitwiseOrExpression )* ;
	...
	private NCalcParser.booleanAndExpression_return booleanAndExpression()
	{
		...
		try
		{
			// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:100:2: (left= bitwiseOrExpression ( ( '&&' | 'and' ) right= bitwiseOrExpression )* )
			DebugEnterAlt(1);
			// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:100:4: left= bitwiseOrExpression ( ( '&&' | 'and' ) right= bitwiseOrExpression )*
			{
			root_0 = (CommonTree)adaptor.Nil();
			...
			// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:100:55: ( ( '&&' | 'and' ) right= bitwiseOrExpression )*
			...
			while (true)
			{
				...
				case 1:
					DebugEnterAlt(1);
					// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:101:4: ( '&&' | 'and' ) right= bitwiseOrExpression
					{
					DebugLocation(101, 4);
	...
	// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:106:1: bitwiseOrExpression returns [LogicalExpression value] : left= bitwiseXOrExpression ( '|' right= bitwiseOrExpression )* ;
	...
	private NCalcParser.bitwiseOrExpression_return bitwiseOrExpression()
	{
		...
		try
		{
			// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:110:2: (left= bitwiseXOrExpression ( '|' right= bitwiseOrExpression )* )
			DebugEnterAlt(1);
			// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:110:4: left= bitwiseXOrExpression ( '|' right= bitwiseOrExpression )*
			{
			root_0 = (CommonTree)adaptor.Nil();
			...
			// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:110:56: ( '|' right= bitwiseOrExpression )*
			...
			while (true)
			{
				...
				case 1:
					DebugEnterAlt(1);
					// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:111:4: '|' right= bitwiseOrExpression
					{
					DebugLocation(111, 4);
	...
	// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:116:1: bitwiseXOrExpression returns [LogicalExpression value] : left= bitwiseAndExpression ( '^' right= bitwiseAndExpression )* ;
	...
	private NCalcParser.bitwiseXOrExpression_return bitwiseXOrExpression()
	{
		...
		try
		{
			// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:120:2: (left= bitwiseAndExpression ( '^' right= bitwiseAndExpression )* )
			DebugEnterAlt(1);
			// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:120:4: left= bitwiseAndExpression ( '^' right= bitwiseAndExpression )*
			{
			root_0 = (CommonTree)adaptor.Nil();
			...
			// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:120:56: ( '^' right= bitwiseAndExpression )*
			...
			while (true)
			{
				...
				case 1:
					DebugEnterAlt(1);
					// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:121:4: '^' right= bitwiseAndExpression
					{
					DebugLocation(121, 4);
	...
	// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:126:1: bitwiseAndExpression returns [LogicalExpression value] : left= equalityExpression ( '&' right= equalityExpression )* ;
	...
	private NCalcParser.bitwiseAndExpression_return bitwiseAndExpression()
	{
		...
		try
		{
			// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:130:2: (left= equalityExpression ( '&' right= equalityExpression )* )
			DebugEnterAlt(1);
			// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:130:4: left= equalityExpression ( '&' right= equalityExpression )*
			{
			root_0 = (CommonTree)adaptor.Nil();
			...
			// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:130:54: ( '&' right= equalityExpression )*
			...
			while (true)
			{
				...
				case 1:
					DebugEnterAlt(1);
					// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:131:4: '&' right= equalityExpression
					{
					DebugLocation(131, 4);
	...
	// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:136:1: equalityExpression returns [LogicalExpression value] : left= relationalExpression ( ( ( '==' | '=' ) | ( '!=' | '<>' ) ) right= relationalExpression )* ;
	...
	private NCalcParser.equalityExpression_return equalityExpression()
	{
		...
		try
		{
			// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:140:2: (left= relationalExpression ( ( ( '==' | '=' ) | ( '!=' | '<>' ) ) right= relationalExpression )* )
			DebugEnterAlt(1);
			// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:140:4: left= relationalExpression ( ( ( '==' | '=' ) | ( '!=' | '<>' ) ) right= relationalExpression )*
			{
			root_0 = (CommonTree)adaptor.Nil();
			...
			// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:140:56: ( ( ( '==' | '=' ) | ( '!=' | '<>' ) ) right= relationalExpression )*
			...
			while (true)
			{
				...
				case 1:
					DebugEnterAlt(1);
					// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:141:4: ( ( '==' | '=' ) | ( '!=' | '<>' ) ) right= relationalExpression
					{
					DebugLocation(141, 4);
					// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:141:4: ( ( '==' | '=' ) | ( '!=' | '<>' ) )
					int alt7=2;
					...
					case 1:
						DebugEnterAlt(1);
						// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:141:6: ( '==' | '=' )
						{
						DebugLocation(141, 6);
					...
					case 2:
						DebugEnterAlt(2);
						// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:142:6: ( '!=' | '<>' )
						{
						DebugLocation(142, 6);
	...
	// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:147:1: relationalExpression returns [LogicalExpression value] : left= shiftExpression ( ( '<' | '<=' | '>' | '>=' ) right= shiftExpression )* ;
	...
	private NCalcParser.relationalExpression_return relationalExpression()
	{
		...
		try
		{
			// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:151:2: (left= shiftExpression ( ( '<' | '<=' | '>' | '>=' ) right= shiftExpression )* )
			DebugEnterAlt(1);
			// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:151:4: left= shiftExpression ( ( '<' | '<=' | '>' | '>=' ) right= shiftExpression )*
			{
			root_0 = (CommonTree)adaptor.Nil();
			...
			// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:151:51: ( ( '<' | '<=' | '>' | '>=' ) right= shiftExpression )*
			...
			while (true)
			{
				...
				case 1:
					DebugEnterAlt(1);
					// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:152:4: ( '<' | '<=' | '>' | '>=' ) right= shiftExpression
					{
					DebugLocation(152, 4);
					// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:152:4: ( '<' | '<=' | '>' | '>=' )
					int alt9=4;
					...
					case 1:
						DebugEnterAlt(1);
						// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:152:6: '<'
						{
						DebugLocation(152, 6);
					...
					case 2:
						DebugEnterAlt(2);
						// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:153:6: '<='
						{
						DebugLocation(153, 6);
					...
					case 3:
						DebugEnterAlt(3);
						// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:154:6: '>'
						{
						DebugLocation(154, 6);
					...
					case 4:
						DebugEnterAlt(4);
						// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:155:6: '>='
						{
						DebugLocation(155, 6);
	...
	// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:160:1: shiftExpression returns [LogicalExpression value] : left= additiveExpression ( ( '<<' | '>>' ) right= additiveExpression )* ;
	...
	private NCalcParser.shiftExpression_return shiftExpression()
	{
		...
		try
		{
			// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:164:2: (left= additiveExpression ( ( '<<' | '>>' ) right= additiveExpression )* )
			DebugEnterAlt(1);
			// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:164:4: left= additiveExpression ( ( '<<' | '>>' ) right= additiveExpression )*
			{
			root_0 = (CommonTree)adaptor.Nil();
			...
			// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:164:54: ( ( '<<' | '>>' ) right= additiveExpression )*
			...
			while (true)
			{
				...
				case 1:
					DebugEnterAlt(1);
					// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:165:4: ( '<<' | '>>' ) right= additiveExpression
					{
					DebugLocation(165, 4);
					// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:165:4: ( '<<' | '>>' )
					int alt11=2;
					...
					case 1:
						DebugEnterAlt(1);
						// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:165:6: '<<'
						{
						DebugLocation(165, 6);
					...
					case 2:
						DebugEnterAlt(2);
						// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:166:6: '>>'
						{
						DebugLocation(166, 6);
	...
	// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:171:1: additiveExpression returns [LogicalExpression value] : left= multiplicativeExpression ( ( '+' | '-' ) right= multiplicativeExpression )* ;
	...
	private NCalcParser.additiveExpression_return additiveExpression()
	{
		...
		try
		{
			// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:175:2: (left= multiplicativeExpression ( ( '+' | '-' ) right= multiplicativeExpression )* )
			DebugEnterAlt(1);
			// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:175:4: left= multiplicativeExpression ( ( '+' | '-' ) right= multiplicativeExpression )*
			{
			root_0 = (CommonTree)adaptor.Nil();
			...
			// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:175:60: ( ( '+' | '-' ) right= multiplicativeExpression )*
			...
			while (true)
			{
				...
				case 1:
					DebugEnterAlt(1);
					// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:176:4: ( '+' | '-' ) right= multiplicativeExpression
					{
					DebugLocation(176, 4);
					// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:176:4: ( '+' | '-' )
					int alt13=2;
					...
					case 1:
						DebugEnterAlt(1);
						// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:176:6: '+'
						{
						DebugLocation(176, 6);
					...
					case 2:
						DebugEnterAlt(2);
						// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:177:6: '-'
						{
						DebugLocation(177, 6);
	...
	// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:182:1: multiplicativeExpression returns [LogicalExpression value] : left= unaryExpression ( ( '*' | '/' | '%' ) right= unaryExpression )* ;
	...
	private NCalcParser.multiplicativeExpression_return multiplicativeExpression()
	{
		...
		try
		{
			// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:186:2: (left= unaryExpression ( ( '*' | '/' | '%' ) right= unaryExpression )* )
			DebugEnterAlt(1);
			// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:186:4: left= unaryExpression ( ( '*' | '/' | '%' ) right= unaryExpression )*
			{
			root_0 = (CommonTree)adaptor.Nil();
			...
			// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:186:52: ( ( '*' | '/' | '%' ) right= unaryExpression )*
			...
			while (true)
			{
				...
				case 1:
					DebugEnterAlt(1);
					// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:187:4: ( '*' | '/' | '%' ) right= unaryExpression
					{
					DebugLocation(187, 4);
					// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:187:4: ( '*' | '/' | '%' )
					int alt15=3;
					...
					case 1:
						DebugEnterAlt(1);
						// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:187:6: '*'
						{
						DebugLocation(187, 6);
					...
					case 2:
						DebugEnterAlt(2);
						// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:188:6: '/'
						{
						DebugLocation(188, 6);
					...
					case 3:
						DebugEnterAlt(3);
						// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:189:6: '%'
						{
						DebugLocation(189, 6);
	...
	// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:195:1: unaryExpression returns [LogicalExpression value] : ( primaryExpression | ( '!' | 'not' ) primaryExpression | ( '~' ) primaryExpression | '-' primaryExpression );
	...
	private NCalcParser.unaryExpression_return unaryExpression()
	{
		...
		try
		{
			// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:196:2: ( primaryExpression | ( '!' | 'not' ) primaryExpression | ( '~' ) primaryExpression | '-' primaryExpression )
			int alt17=4;
			...
			case 1:
				DebugEnterAlt(1);
				// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:196:4: primaryExpression
				{
				root_0 = (CommonTree)adaptor.Nil();
			...
			case 2:
				DebugEnterAlt(2);
				// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:197:8: ( '!' | 'not' ) primaryExpression
				{
				root_0 = (CommonTree)adaptor.Nil();
			...
			case 3:
				DebugEnterAlt(3);
				// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:198:8: ( '~' ) primaryExpression
				{
				root_0 = (CommonTree)adaptor.Nil();

				DebugLocation(198, 8);
				// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:198:8: ( '~' )
				DebugEnterAlt(1);
				// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:198:9: '~'
				{
				DebugLocation(198, 9);
			...
			case 4:
				DebugEnterAlt(4);
				// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:199:8: '-' primaryExpression
				{
				root_0 = (CommonTree)adaptor.Nil();
	...
	// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:202:1: primaryExpression returns [LogicalExpression value] : ( '(' logicalExpression ')' |expr= value | identifier ( arguments )? );
	...
	private NCalcParser.primaryExpression_return primaryExpression()
	{
		...
		try
		{
			// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:203:2: ( '(' logicalExpression ')' |expr= value | identifier ( arguments )? )
			int alt19=3;
			...
			case 1:
				DebugEnterAlt(1);
				// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:203:4: '(' logicalExpression ')'
				{
				root_0 = (CommonTree)adaptor.Nil();
			...
			case 2:
				DebugEnterAlt(2);
				// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:204:4: expr= value
				{
				root_0 = (CommonTree)adaptor.Nil();
			...
			case 3:
				DebugEnterAlt(3);
				// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:205:4: identifier ( arguments )?
				{
				root_0 = (CommonTree)adaptor.Nil();
				...
				// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:205:66: ( arguments )?
				int alt18=2;
				...
				case 1:
					DebugEnterAlt(1);
					// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:205:67: arguments
					{
	...
	// $ANTLR start "value"
	// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:208:1: value returns [ValueExpression value] : ( INTEGER | FLOAT | STRING | DATETIME | TRUE | FALSE );
	[GrammarRule("value")]
	private NCalcParser.value_return value()
	{
		...
		try
		{
			// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:209:2: ( INTEGER | FLOAT | STRING | DATETIME | TRUE | FALSE )
			int alt20=6;
			...
			case 1:
				DebugEnterAlt(1);
				// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:209:5: INTEGER
				{
				root_0 = (CommonTree)adaptor.Nil();
			...
			case 2:
				DebugEnterAlt(2);
				// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:210:4: FLOAT
				{
				root_0 = (CommonTree)adaptor.Nil();
			...
			case 3:
				DebugEnterAlt(3);
				// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:211:4: STRING
				{
				root_0 = (CommonTree)adaptor.Nil();
			...
			case 4:
				DebugEnterAlt(4);
				// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:212:5: DATETIME
				{
				root_0 = (CommonTree)adaptor.Nil();
			...
			case 5:
				DebugEnterAlt(5);
				// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:213:4: TRUE
				{
				root_0 = (CommonTree)adaptor.Nil();
			...
			case 6:
				DebugEnterAlt(6);
				// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:214:4: FALSE
				{
				root_0 = (CommonTree)adaptor.Nil();
	...
	// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:217:1: identifier returns [Identifier value] : ( ID | NAME );
	...
	private NCalcParser.identifier_return identifier()
	{
		...
		try
		{
			// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:218:2: ( ID | NAME )
			int alt21=2;
			...
			case 1:
				DebugEnterAlt(1);
				// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:218:5: ID
				{
				root_0 = (CommonTree)adaptor.Nil();
			...
			case 2:
				DebugEnterAlt(2);
				// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:219:5: NAME
				{
				root_0 = (CommonTree)adaptor.Nil();
	...
	// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:222:1: expressionList returns [List<LogicalExpression> value] : first= logicalExpression ( ',' follow= logicalExpression )* ;
	...
	private NCalcParser.expressionList_return expressionList()
	{
		...
		try
		{
			// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:226:2: (first= logicalExpression ( ',' follow= logicalExpression )* )
			DebugEnterAlt(1);
			// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:226:4: first= logicalExpression ( ',' follow= logicalExpression )*
			{
			root_0 = (CommonTree)adaptor.Nil();
			...
			// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:226:62: ( ',' follow= logicalExpression )*
			...
			while (true)
			{
				...
				case 1:
					DebugEnterAlt(1);
					// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:226:64: ',' follow= logicalExpression
					{
	...
	// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:230:1: arguments returns [List<LogicalExpression> value] : '(' ( expressionList )? ')' ;
	...
	private NCalcParser.arguments_return arguments()
	{
		...
		try
		{
			// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:234:2: ( '(' ( expressionList )? ')' )
			DebugEnterAlt(1);
			// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:234:4: '(' ( expressionList )? ')'
			{
			root_0 = (CommonTree)adaptor.Nil();
			...
			DebugLocation(234, 8);
			// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:234:8: ( expressionList )?
			int alt23=2;
			...
			case 1:
				DebugEnterAlt(1);
				// C:\\MyTemp\\dev\\ncalc grammar test\\Grammar\\NCalc.g:234:10: expressionList
				{
